...
<body>
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="index.jsp">Hello <%if(us!=null){out.print(UserDetailDAO.mapUserDetail.get(us.getUserID()).getFullname());} %>,</a>
	</div>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav side-nav">
			...
			<li><a href="Role/role.jsp"><i class="fa fa-check-square-o"></i> Quản lý phân quyền</a></li>
