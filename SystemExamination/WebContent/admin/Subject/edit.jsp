...
<% String subjectID = request.getParameter("subjectID"); 
	Subject us = SubjectDAO.mapSubject.get(subjectID);
%>
	...
	<div id="wrapper">
		...
		<div class="noidung">
			<div class="row" style="margin-left:30px; margin-right:30px">
				<h2><strong>Sửa thông tin môn học</strong>
			...
			<div class="noidungcon">
				<form id="editSubject" data-parsley-validate class="form-horizontal form-label-left"  action="../../Subject?action=EDIT&subjectID=<%=subjectID %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
 						...
 						<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tên môn học <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="SubjectName"  name="subjectName" class="form-control col-md-7 col-xs-12" value="<%=us.getSubjectName()%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Link ảnh <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="linkImage"  name="linkImage" class="form-control col-md-7 col-xs-12" value="<%=us.getLinkImage()%>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input id="describe"  name="describe" class="form-control col-md-7 col-xs-12" value="<%=us.getDescribe() %>">
                               </div>
                               <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Danh sách bài thi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <label for="sel2">Danh sách (Giữ phím Shift để chọn nhiều hơn):</label>
