	...
	<div id="wrapper">
		...
		<div class="noidung">
			...
			<div class="noidungcon">
				<form id="editUser" data-parsley-validate class="form-horizontal form-label-left"  action="../../User?action=EDIT_USER&userID=<%=UserID %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="userID" name="ID" class="form-control col-md-7 col-xs-12" value="<%=us.getUserID()%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-userID"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="email"  name="email" class="form-control col-md-7 col-xs-12" value="<%=us.getEmail()%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-email"></p>
                               </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="password" id="password"  name="password" class="form-control col-md-7 col-xs-12" value="<%=us.getPassword()%>">
                               </div>
                               <div class="col-sm-2">
