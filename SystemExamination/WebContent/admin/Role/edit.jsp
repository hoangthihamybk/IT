...
<% String roleID = request.getParameter("roleID"); 
	Role us = RoleDAO.mapRole.get(roleID);
%>
			...
			<div class="noidungcon">
				<form id="editRole" data-parsley-validate class="form-horizontal form-label-left"  action="../../Role?action=EDIT&roleID=<%=roleID %>" method="post">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="roleID" name="ID" class="form-control col-md-7 col-xs-12" value="<%=us.getRoleID()%>">
                               </div>
                               <div class="col-sm-2">
                                <p id="icon-roleID"></p>
                               </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                               <div class="col-sm-8">
                                <input type="text" id="roleName"  name="roleName" class="form-control col-md-7 col-xs-12" value="<%=us.getRoleName()%>">
                               </div>
                               <div class="col-sm-2">
