...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%UserAccount us =(UserAccount) session.getAttribute("loginstudent");
if(us==null){
...
<body>
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="index.jsp">Hello <%if(us!=null){
			out.print(UserDetailDAO.mapUserDetail.get(us.getUserID()).getFullname());
			} %>admin 123,</a>
	</div>
