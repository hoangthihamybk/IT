	...
	<div id="wrapper">
		...
		<div class="noidung">
			...
			<div class="row" style="margin-left:30px; margin-right:30px">
				<h2><strong>Thêm bài thi mới</strong>
			...
			<div class="noidungcon">
				<form id="addExam" data-parsley-validate class="form-horizontal form-label-left"  action="../../Examination?action=ADD" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="text" id="linkContent"  name="linkContent" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="row">
                               <div class="col-sm-8">
                                 <input type="date" id="dateCreate"  name="dateCreate" class="form-control col-md-7 col-xs-12" >
                               </div>
                               <div class="col-sm-2">
