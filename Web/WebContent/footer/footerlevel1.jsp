...
<div id="footer-new">
    <div class="wrapper clearfix top-botton-footer-new">
        <div class="footer-right col2">
            <div class="clearfix">
                <div class="footer-block col2">
                    <h3 class="footer-block-title-new">VỀ HỌC ONLINE</h3><span class="click-plus"><i class="fa fa-plus" aria-hidden="true"></i></span>
                    <ul class="footer-block-list rp-footer" data-closep="0">
                        ...
                        <li><a href="https://hocmai.vn/privacy2.php" target="_blank">Điều khoản chính sách</a></li>
                        <li><a href="https://hocmai.vn/tuyen-dung" target="_blank">Tuyển dụng</a></li>

                    </ul>
                </div>
                <div class="footer-block col2">
                    <h3 class="footer-block-title-new">TIỆN ÍCH </h3><span class="click-plus"><i class="fa fa-plus" aria-hidden="true"></i></span>
                    <ul class="footer-block-list rp-footer" data-closep="0">
                        <li><a href="https://hocmai.vn/kho-tai-lieu/" target="_blank">Thư viện</a></li>
                        <li><a href="http://butbi.hocmai.vn/" target="_blank">Blog THPT</a></li>
                        <li><a href="http://diendan.hocmai.vn/index.php" target="_blank">Diễn đàn HỌC OLINE</a></li>                        
        ...
        <div class="footer-left col2">
            <div class="clearfix" style="height: 200px;">
                <div class="footer-block col2 right-footer-first">
                    ...
                    <ul class="hotline-icon footer-block-list-new rp-footer" data-closep="0">
                        ...
                        <li><span style="color: #a6a6a6;font-weight: bold;font-size: 13px;"> Email: hotro@hoconline.vn</span></li>
                        <li><span style="color: #a6a6a6;font-weight: bold;font-size: 13px;"> Đường dây nóng: 1900 6933</span></li>
                        <li></li>
                    </ul>

                </div>
                <div class="footer-block col2 right-footer-second">
                    <h3 class="footer-block-title-new hide-rp-title-footer">TẢI ỨNG DỤNG HỌC ONLINE</h3>
                    <a title="Tải ứng dụng HOCMAI Lectures" target="_blank" href="https://play.google.com/store/apps/details?id=hocmai.vn.activity">
                        <img class="footer-image-app" src="https://hocmai.vn/theme/new2/images/footer-google-app.png"/>
                    </a>
                    <a title="Tải ứng dụng HOCMAI Lectures" target="_blank" href="https://itunes.apple.com/us/app/hocmai-lectures/id1080261777?ls=1&amp;mt=8">
                        <img class="footer-image-app"  src="https://hocmai.vn/theme/new2/images/footer-store-app.png"/>
                    </a>
                    <a title="" target="_blank" href="http://online.gov.vn/CustomWebsiteDisplay.aspx?DocId=2332">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <p class="footer-des-new">
                    ...
                    Tel: +84 (24) 3519-0591 Fax: +84 (24) 3519-0587<br />
