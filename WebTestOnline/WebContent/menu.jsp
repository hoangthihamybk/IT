...
<body>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav side-nav">
			...
			<li><a href="hocsinh.jsp"><i class="fa fa-users"></i> Học
					sinh</a></li>
			<li><a href="bomon.jsp"><i class="fa fa-book"></i> Bộ môn</a></li>
			<li><a href="baithi.jsp"><i class="fa fa-file-text-o"></i>
					Bài thi</a></li>
			<li><a href="xemketqua.jsp"><i class="fa fa-question-circle"></i>
					Xem kết quả </a></li>
			<li><a href="cauhoi.jsp"><i class="fa fa-check-square-o"></i>
					Câu hỏi</a></li>
