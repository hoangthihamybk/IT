		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><span>H</span>ọc Online</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav w3-agileits_home_nav">
							...
							<li>
								<a class="link link--yaku scroll" href="#services">
									<span>Tại</span><span>đây</span><span>có</span><span>gì?</span>					
								</a>
							</li>
							<li>
								<a class="link link--yaku scroll" href="#about">
									<span>Về</span><span>Chúng</span><span>Tôi</span>							
								</a>
							</li>
							<li>
								<a class="link link--yaku scroll" href="#gallery">
									<span>Lớp</span><span>Học</span>				
								</a>
							</li>
							<li>
		...
		<div class="container">
			...
			<div class="col-md-3 w3_agileits_banner_bottom_right">
				<div class="w3_agileits_banner_bottom_right_pos">
					...
					<p>Đến với hệ thống bạn sẽ trang bị cho mình lượng kiến thức tốt nhất cho kì thi sắp tới.
					 </br>HỌC ONLINE - bầu trời kiến thức.</p>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- services -->
	<div class="services" id="services">
		<div class="container">
			<h3 class="wthree_head"><i class="fa fa-book" aria-hidden="true"></i><span>Học Online</span>Đồng hành</h3>
			<div class="agileinfo_services_grids">
				<div class="col-md-4 agileinfo_services_grid">
					...
					<div class="clearfix"> </div>
					<p>Cung cấp thông tin bổ ích cho các bạn chuẩn bị thi kì thi THPT quốc gia:
					trường, điểm sàn, điểm chuẩn,...</p>
				</div>
				<div class="col-md-4 agileinfo_services_grid">
					<div class="agileinfo_services_grid_left">
						<h4>Luyện thi</h4>
					...
					<div class="clearfix"> </div>
					<p>Thử sức với những bài thi giúp các bạn làm chủ thời gian hơn.
					Đăng kí ngay để thử sức nào.</p>
				</div>
				<div class="col-md-4 agileinfo_services_grid">
					<div class="agileinfo_services_grid_left">
						<h4>Kho tài liệu</h4>
					...
					<div class="clearfix"> </div>
					<p>Kho tài liệu phong phú với chất lượng hay được tuyển chọn bở đội ngũ admin tâm huyết.</p>
				</div>
				<div class="col-md-4 agileinfo_services_grid">
					<div class="agileinfo_services_grid_left">
						<h4>Hỏi-Đáp</h4>
					...
					<div class="clearfix"> </div>
					<p>Ngôi nhà chung nơi các bạn học sinh có thể trao đổi cũng như giải đáp các
					thắc mắc của mình và các bạn.</p>
				</div>
				<div class="col-md-4 agileinfo_services_grid">
					<div class="agileinfo_services_grid_left">
						<h4>Test IQ</h4>
				...
				<div class="col-md-4 agileinfo_services_grid">
					...
					<div class="clearfix"> </div>
					<p>Vậy còn chần chờ gì nữa. Hãy ĐĂNG KÝ để tham gia cùng chúng mình.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<!-- team -->
	<div class="team">
		<div class="container">
			<h3 class="wthree_head wthree_head1"><i class="fa fa-users" aria-hidden="true"></i><span>Học Online</span>Team Admin</h3>
		...
		<div class="container">
			...
			<div class="w3l_gallery_grids">
				<ul class="w3l_gallery_grid gallery" id="lightGallery">
					...
					<li data-title="Graduate" data-desc="Lorem Ipsum is simply dummy text of the printing." data-src="images/5.jpg" data-responsive-src="images/5.jpg"> 
						<div class="w3_w3l_gallery_grid box">
							<a href="#">
					...
					<li data-title="Graduate" data-desc="Lorem Ipsum is simply dummy text of the printing." data-src="images/8.jpg" data-responsive-src="images/8.jpg"> 
						<div class="w3_w3l_gallery_grid box">
							<a href="#">
					...
					<li data-title="Graduate" data-desc="Lorem Ipsum is simply dummy text of the printing." data-src="images/10.jpg" data-responsive-src="images/10.jpg"> 
						<div class="w3_w3l_gallery_grid box">
							<a href="#">
