...
public class Subject {
	...
	public Subject(String subjectID, String subjectName, String linkImage, String describe, List listOfExaminationID,
			String enable) {
		super();
	...
	public List getListOfExaminationID() {
		return listOfExaminationID;
	}
	public void setListOfExaminationID(List listOfExaminationID) {
		this.listOfExaminationID = listOfExaminationID;
	}
